...
var _scrambleTextPluginMinJs = require("./ScrambleTextPlugin.min.js");
var _scrambleTextPluginMinJsDefault = parcelHelpers.interopDefault(_scrambleTextPluginMinJs);
var _utilsJs = require("./utils.js");
var _factionsSliderJs = require("./factionsSlider.js");
var _factionsSliderJsDefault = parcelHelpers.interopDefault(_factionsSliderJs);
var _weaponsSliderJs = require("./weaponsSlider.js");
var _weaponsSliderJsDefault = parcelHelpers.interopDefault(_weaponsSliderJs);
var _glitchHeadlinesJs = require("./glitchHeadlines.js");
var _glitchHeadlinesJsDefault = parcelHelpers.interopDefault(_glitchHeadlinesJs);
var _scrambleParagraphsJs = require("./scrambleParagraphs.js");
var _scrambleParagraphsJsDefault = parcelHelpers.interopDefault(_scrambleParagraphsJs);
var _glitchLinksJs = require("./glitchLinks.js");
var _glitchLinksJsDefault = parcelHelpers.interopDefault(_glitchLinksJs);
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger), (0, _textPlugin.TextPlugin), (0, _scrambleTextPluginMinJsDefault.default));
...
window.addEventListener("DOMContentLoaded", (event)=>{
    ...
    function initMusic(e) {
        if (!isLoaded) {
            audioEnabled = true;
            maybePlay(music, ()=>{
                if (!e.target.closest(".play-pause")) musicControl.click();
    ...
    function raf(time) {
        lenis.raf(time);
        (0, _scrollTrigger.ScrollTrigger).update();
    ...
    function initPage() {
        ...
        if (heroIntro) heroIntro.click();
        // Link sounds
        const hoverSounds = (0, _gsap.gsap).utils.toArray(".hover-glitch");
        ...
        const sT = (0, _gsap.gsap).utils.toArray(".scramble");
        sT.forEach((item)=>{
            let tween = (0, _gsap.gsap).to(item, {
                duration: 1,
                scrambleText: {
                    text: "{original}",
                    chars: "F0RTH3W1N2023 "
        ...
        const triangles = (0, _gsap.gsap).utils.toArray(".triangle-button");
        triangles.forEach((item)=>{
            let label = item.querySelector(".triangle-button-label");
            var text = new (0, _splitTypeDefault.default)(label, {
                types: "words",
                tagName: "span"
            });
            let tween = (0, _gsap.gsap).to(text.words, {
                duration: 0.5,
                scrambleText: {
                    text: "{original}",
                    chars: "F0RTH3W1N2023 ",
        ...
        (0, _glitchHeadlinesJsDefault.default)(()=>{
            if (!isLoaded) return;
            maybePlay(headlineGlitch);
        });
        // Scramble Text on Paragraphs ==================================//
        (0, _scrambleParagraphsJsDefault.default)(()=>{
            if (!isLoaded) return;
            maybePlay(headlineGlitch);
        });
        // glitch effect for footer links ====================================== //
        (0, _glitchLinksJsDefault.default)();
        ...
        // Form submit ================================================== //
        if (document.querySelector(".newsletter-submit")) document.querySelector(".newsletter-submit").addEventListener("click", ()=>{
            document.querySelector(".form-submit-hidden").click();
        });
        // Factions Slider ============================================== //
        if (document.querySelector(".factions-slider-wrapper")) (0, _factionsSliderJsDefault.default)(()=>{
            // Play glitch effect
            if (!isLoaded) return;
            maybePlay(headlineGlitch);
        });
        // Weapons Slider ============================================== //
        if (document.querySelector(".weapons-slider")) (0, _weaponsSliderJsDefault.default)(()=>{
            // Play glitch effect
            if (!isLoaded) return;
            maybePlay(headlineGlitch);
        });
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "checkIfLoaded", ()=>checkIfLoaded);
...
function createScrollTrigger(triggerElement, timeline, reverse, start, end, delay, audio, once, noOverlapping) {
    ...
    (0, _scrollTrigger.ScrollTrigger).create({
        ...
        onEnter: (self)=>{
            ...
            if (once) self.disable(false, true);
        },
        onEnterBack: ()=>{
            if (shouldReverse) timeline.timeScale(1).play();
        },
        onLeave: (self)=>{
            if (shouldReverse) timeline.timeScale(2).reverse();
        },
        onLeaveBack: ()=>{
            if (shouldReverse) timeline.timeScale(2).reverse();
        }
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"akLbX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>initFactionsSlider);
var _gsap = require("gsap");
var _scrollTrigger = require("gsap/ScrollTrigger");
var _textPlugin = require("gsap/TextPlugin");
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger), (0, _textPlugin.TextPlugin));
function initFactionsSlider(transitionCallback) {
    const heroes = (0, _gsap.gsap).utils.toArray(".factions-slider-hero");
    let factions = {
        homefront: [],
        sapiens: []
    };
    let currentIndex = 0, prevIndex = 0, currentFaction = "", prevHero = null, currentHero = null;
    // Populate hero data
    heroes.forEach((hero)=>{
      ...
      <div class="slice bottom-third"></div>`;
        ...
        if ([
            "homefront",
            "sapiens"
        ].includes(faction)) factions[faction].push(heroData);
    });
    // Slider controls
    const next = document.querySelector(".factions-slider-controls .slider-arrow.next"), prev = document.querySelector(".factions-slider-controls .slider-arrow.prev"), label = document.querySelector(".factions-slider-controls-name"), labelTl = (0, _gsap.gsap).timeline();
    ...
    function updateIndex(type) {
        if (type === "next") {
            ...
            currentIndex = currentIndex >= factions[currentFaction].length - 1 ? 0 : currentIndex + 1;
        }
        if (type === "prev") {
            prevIndex = currentIndex;
            currentIndex = currentIndex - 1 < 0 ? factions[currentFaction].length - 1 : currentIndex - 1;
        }
    }
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gsap/TextPlugin":"9TeAU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1wrY7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>initWeaposSlider);
var _gsap = require("gsap");
var _scrollTrigger = require("gsap/ScrollTrigger");
var _textPlugin = require("gsap/TextPlugin");
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger), (0, _textPlugin.TextPlugin));
function initWeaposSlider() {
    ...
    let weapons = [];
    let currentWeaponIndex = 0, prevWeaponIndex = 0, prevWeapon = null, currentWeapon = null;
    // Populate hero data
    ...
    // Slider controls
    const weaponsNext = document.querySelector(".weapons-slider-controls .slider-arrow.next"), weaponsPrev = document.querySelector(".weapons-slider-controls .slider-arrow.prev"), damageBar = document.querySelector(".weapons-stats-bar-inner.damage"), accuracyBar = document.querySelector(".weapons-stats-bar-inner.accuracy"), fireRateBar = document.querySelector(".weapons-stats-bar-inner.fire-rate"), damageTL = (0, _gsap.gsap).timeline(), accuracyTL = (0, _gsap.gsap).timeline(), fireRateTL = (0, _gsap.gsap).timeline(), weaponlabel = document.querySelector(".weapons-slider-controls-name"), weaponlabelTl = (0, _gsap.gsap).timeline();
    ...
    function transitionWeapon() {
        ...
        // update weapon hame
        weaponlabelTl.to(weaponlabel, {
            text: "",
            duration: 0.25,
            ease: "sine.in"
        }).delay(0.25).to(weaponlabel, {
            text: currentWeapon.name,
            duration: 0.25,
            ease: "sine.in"
        });
        if (!prevWeapon) currentWeapon.tl.play();
        else {
    ...
    function updateWeaponIndex(type) {
        ...
        if (type === "prev") {
            prevWeaponIndex = currentWeaponIndex;
            currentWeaponIndex = currentWeaponIndex - 1 < 0 ? weapons.length - 1 : currentWeaponIndex - 1;
        }
    }
...
},{"gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gsap/TextPlugin":"9TeAU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8NrJU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>initGlitchHeadlines);
var _splitType = require("split-type");
var _splitTypeDefault = parcelHelpers.interopDefault(_splitType);
var _gsap = require("gsap");
var _scrollTrigger = require("gsap/ScrollTrigger");
var _utilsJs = require("./utils.js");
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger));
function initGlitchHeadlines(transitionCallback) {
    new (0, _splitTypeDefault.default)("[glitch-effect]", {
        types: "words",
        tagName: "span"
    });
    ...
    const headlines = (0, _gsap.gsap).utils.toArray("[glitch-effect]");
    headlines.forEach((words)=>{
        ...
        (0, _utilsJs.createScrollTrigger)(trigger, tl, true, start, end, delay, true, once);
    });
    (0, _gsap.gsap).set("[glitch-effect]", {
        opacity: 1
    });
    (0, _gsap.gsap).set("[glitch-effect] .word", {
        opacity: 0,
        y: "random(-50%, 50%)",
        x: "random(-50%, 50%)"
    });
...
},{"split-type":"fvGAG","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","./utils.js":"en4he","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"auMN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>initScrambleParagraphs);
var _splitType = require("split-type");
var _splitTypeDefault = parcelHelpers.interopDefault(_splitType);
var _gsap = require("gsap");
var _scrollTrigger = require("gsap/ScrollTrigger");
...
var _utilsJs = require("./utils.js");
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger), (0, _textPlugin.TextPlugin));
function initScrambleParagraphs(transitionCallback) {
    ...
    scrambleParagraphs.forEach((item)=>{
        ...
        (0, _utilsJs.createScrollTrigger)(trigger, tl, true, start, end, delay, false, once, "scramble");
    });
}

},{"split-type":"fvGAG","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","gsap/TextPlugin":"9TeAU","./utils.js":"en4he","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3aMOA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>initGlitchLinks);
var _gsap = require("gsap");
function initGlitchLinks(transitionCallback) {
...
},{"gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["igKGj","8lqZg"], "8lqZg", "parcelRequirea580")
